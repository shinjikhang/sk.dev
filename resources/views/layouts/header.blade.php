...
<head>
  ...
  <!-- fevicon -->
  <link rel="icon" href="{{ asset('fe/images/fevicon.png') }}" type="image/gif" />
  <!-- Scrollbar Custom CSS -->
  <link rel="stylesheet" href="{{ asset('fe/css/jquery.mCustomScrollbar.min.css') }}">
  ...
  <div class="header_section">
    <div class="container">
      <nav class="navbar navbar-dark bg-dark">
        <a class="logo" href=""><img src="{{ asset('fe/images/logo.png') }}"></a>
        <div class="search_section">
          <ul>
            <li><a href="#">Log In</a></li>
            <li><a href="#"><img src="{{ asset('fe/images/shopping-bag.png') }}"></a></li>
            <li><a href="#"><img src="{{ asset('fe/images/search-icon.png') }}"></a></li>
          </ul>
        </div>
    ...
    <div class="banner_section layout_padding">
      <div id="my_slider" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-item active">
            <div class="container">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div><img src="{{ asset('fe/images/img-1.png') }}" class="image_1"></div>
                </div>
              </div>
        ...
        <a class="carousel-control-prev" href="#my_slider" role="button" data-slide="prev">
          <i class=""><img src="{{ asset('fe/images/left-icon.png') }}"></i>
        </a>
        <a class="carousel-control-next" href="#my_slider" role="button" data-slide="next">
          <i class=""><img src="{{ asset('fe/images/right-icon.png') }}"></i>
        </a>
      </div>
    </div>
    <!--banner section end -->
      ...
      <div class="row">
        <div class="col-lg-4 col-sm-12">
          <div class="beds_section active">
            ...
            <div><img src="{{ asset('fe/images/img-2.png') }}" class="image_2"></div>
        ...
        <div class="col-lg-4 col-sm-12">
          <div class="beds_section">
            ...
            <div><img src="{{ asset('fe/images/img-3.png') }}" class="image_2"></div>
            <div class="seemore_bt"><a href="#">see More</a></div>
          </div>
        </div>
        <div class="col-lg-4 col-sm-12">
      ...
      <div class="row">
        <div class="col-lg-4 col-sm-12">
          <div class="beauty_box">
            ...
            <div><img src="{{ asset('fe/images/img-5.png') }}" class="image_3"></div>
            <div class="seemore_bt"><a href="#">see More</a></div>
          </div>
        </div>
        <div class="col-lg-8 col-sm-12">
          <div class="beauty_box_1">
            ...
            <div><img src="{{ asset('fe/images/img-6.png') }}" class="image_3"></div>
        ...
        <div class="row">
          <div class="col-sm-5">
            <div class="feature_box">
              ...
              <div><img src="{{ asset('fe/images/img-7.png') }}" class="image_7"></div>
            </div>
          ...
          <div class="col-sm-7">
            <div class="feature_box_2">
              <h1 class="readable_text">Readable content of</h1>
              <div><img src="{{ asset('fe/images/img-8.png') }}" class="image_8"></div>
              <div class="seemore_bt"><a href="#">see More</a></div>
            </div>
          </div>
        </div>
        ...
        <div class="carousel-item active">
          <div class="container">
            ...
            <div class="client_section_2">
              <div class="image_9"><img src="{{ asset('fe/images/img-8.png') }}"></div>
              ...
              <div class="image_9"><img src="{{asset('fe/images/icon-10.png')}}"></div>
            </div>
          </div>
        </div>
        <div class="carousel-item">
          <div class="container">
            ...
            <p class="feature_text">It is a long established fact that a reader will be distracted by the readable content of a page when looking</p>
            <div class="client_section_2">
              <div class="image_9"><img src="{{ asset('fe/images/img-9.png') }}"></div>
              <h3 class="nolmal_text">Normal distribution</h3>
              <p class="ipsum_text">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look</p>
              <div class="image_9"><img src="{{asset('fe/images/icon-10.png')}}"></div>
            </div>
        ...
        <div class="carousel-item">
          <div class="container">
            ...
            <div class="client_section_2">
              ...
              <h3 class="nolmal_text">Normal distribution</h3>
              <p class="ipsum_text">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look</p>
              <div class="image_9"><img src="{{ asset('fe/images/img-10.png') }}"></div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="information_main">
          ...
          <div class="social_icon">
            <ul>
              ...
              <li><a href="#"><img src="{{asset('fe/images/twitter-icon.png')}}"></a></li>
              <li><a href="#"><img src="{{asset('fe/images/linkedin-icon.png')}}"></a></li>
              <li><a href="#"><img src="{{asset('fe/images/instagram-icon.png')}}"></a></li>
            </ul>
          </div>
        </div>
      </div>
